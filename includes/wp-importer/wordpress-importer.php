...
/** WPImporterLogger class */
require_once dirname( __FILE__ ) . '/class-wp-importer-logger.php';

/** WPImporterLoggerCLI class */
require_once dirname( __FILE__ ) . '/class-wp-importer-logger-cli.php';
